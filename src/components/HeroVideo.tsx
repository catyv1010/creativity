...
/**
 * HeroVideo — A stunning scroll-driven reveal of the editor.
 * Starts small and rotated, grows to fullscreen as user scrolls.
 * Shows a REAL-looking editor with vibrant content, not wireframes.
 */
export default function HeroVideo() {
  ...
  useEffect(() => {
    ...
    // Scroll-driven: small rotated → fullscreen
    gsap.fromTo(frame, {
      scale: 0.55,
      rotateX: 12,
      rotateY: -4,
    ...
    // Inner elements animate with stagger as frame grows
  ...
  return (
    <section ref={sectionRef} className="relative h-[200vh] bg-[#030014]">
      <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden" style={{ perspective: "1200px" }}>
        <div
          ref={frameRef}
          className="relative w-full h-full max-w-[95vw] max-h-[90vh] overflow-hidden shadow-[0_40px_120px_rgba(0,0,0,0.6)]"
        >
          {/* REAL-LOOKING EDITOR */}
